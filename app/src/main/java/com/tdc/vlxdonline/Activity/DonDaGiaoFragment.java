...
public class DonDaGiaoFragment extends Fragment {
    FragmentDonDaGiaoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDonDaGiaoBinding.inflate(inflater, container, false);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                try {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        if (don.getTrangThai() < 4 || !don.getIdGiao().equals(Shipper_HomeActivity.nv.getCccd())) continue;
